    ...
    try {
      ...
      if (!!slip10Node.publicKey) {
        ...
        const memo = Buffer.from(
          request.params[1], //'70991c20c7C4e0021Ef0Bd3685876cC3aC5251F0',
          'hex',
        );
        ...
        //     type: 'confirmation',
        //     content: panel([
        //       copyable(`https://mempool.space/testnet/tx/${txhash}`),
